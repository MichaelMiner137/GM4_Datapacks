...
data modify storage gm4_garden_variety:new component.placeholder set value {identifier:1,thickness:2,rounded:true,composite_group:1,pattern:[1,2]}
...
data modify storage gm4_garden_variety:new component.placeholder set value {identifier:1,thickness:1,rounded:true,composite_group:1,pattern:[1,2]}
...
data modify storage gm4_garden_variety:new component.axis set value {method:"free"}
