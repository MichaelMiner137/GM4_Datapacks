...
execute store result score seed_mod gm4_gv_gen_data run data get storage gm4_garden_variety:data/position Pos[0]
scoreboard players operation seed gm4_gv_gen_data *= seed_mod gm4_gv_gen_data
execute store result score seed_mod gm4_gv_gen_data run data get storage gm4_garden_variety:data/position Pos[1]
scoreboard players operation seed gm4_gv_gen_data *= seed_mod gm4_gv_gen_data
execute store result score seed_mod gm4_gv_gen_data run data get storage gm4_garden_variety:data/position Pos[2]
scoreboard players operation seed gm4_gv_gen_data *= seed_mod gm4_gv_gen_data
