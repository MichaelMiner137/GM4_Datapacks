schedule function gm4_garden_variety:10_seconds 10s
...
execute as @e[type=armor_stand,tag=gm4_gv_analyzer] at @s run function gm4_garden_variety:analyzer/arborist/per_analyzer
