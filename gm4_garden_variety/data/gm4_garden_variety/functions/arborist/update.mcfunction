...
execute if score verify_job_site gm4_gv_job_id matches 0 run function gm4_garden_variety:arborist/job/missing_job_site
...
execute if entity @s[tag=gm4_gv_level_2] if score xp_value gm4_gv_arborist matches 70.. run function gm4_garden_variety:arborist/leveling/level_3
...
execute if entity @s[tag=gm4_gv_level_3] if score xp_value gm4_gv_arborist matches 150.. run function gm4_garden_variety:arborist/leveling/level_4
