...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_2/sell_blocks/sell
...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_2/sell_blocks/buy
...
execute if score trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:arborist/trading/trades/level_2/sell_blocks