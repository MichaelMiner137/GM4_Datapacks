...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_2/sell_decor/sell
...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_2/sell_decor/buy
...
execute if data storage gm4_garden_variety:data/arborist/next_trade Recipes.sell{id:"minecraft:bee_nest"} run data modify storage gm4_garden_variety:data/arborist/next_trade Recipes.maxUses set value 1
...
data modify storage gm4_garden_variety:debug/arborist trades.level_2.sell_decor append from storage gm4_garden_variety:data/arborist/next_trade Recipes.sell.id

# loop
scoreboard players remove trade_amount gm4_gv_trades 1
execute if score trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:arborist/trading/trades/level_2/sell_decor