...
# select random trade
data modify storage gm4_garden_variety:data/arborist/natural_trade_data armor_stand_data set from entity @e[type=armor_stand,tag=gm4_gv_decorative_trade_option,limit=1,sort=random] {}
...
# loop
scoreboard players remove trade_6_amount gm4_gv_trades 1
