...
execute if score trade_sell_group gm4_gv_trades matches 0 run scoreboard players operation trade_sell_item gm4_gv_trades %= #5 gm4_math_num
execute if score trade_sell_group gm4_gv_trades matches 1 run scoreboard players operation trade_sell_item gm4_gv_trades %= #6 gm4_math_num
function gm4_garden_variety:get/next_seed_value
...
execute if score trade_sell_group gm4_gv_trades matches 0 if score trade_sell_item gm4_gv_trades matches 0 run scoreboard players operation trade_sell_amount gm4_gv_trades %= #2 gm4_math_num
...
execute if score trade_sell_group gm4_gv_trades matches 0 if score trade_sell_item gm4_gv_trades matches 1 run scoreboard players operation trade_sell_amount gm4_gv_trades %= #4 gm4_math_num
...
execute if score trade_sell_group gm4_gv_trades matches 1 run scoreboard players operation trade_sell_amount gm4_gv_trades %= #3 gm4_math_num
