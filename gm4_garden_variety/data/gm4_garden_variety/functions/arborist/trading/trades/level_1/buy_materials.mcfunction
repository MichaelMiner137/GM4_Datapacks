...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_1/buy_materials/sell
data modify storage gm4_garden_variety:data/arborist/next_trade Recipes.sell set from entity @s HandItems[0]

### buy ###

# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_1/buy_materials/buy
...
execute if score trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:arborist/trading/trades/level_1/buy_materials