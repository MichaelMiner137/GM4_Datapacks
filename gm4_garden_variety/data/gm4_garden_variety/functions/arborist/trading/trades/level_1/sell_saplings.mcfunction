...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_1/sell_saplings/sell
...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:arborist/trades/level_1/sell_saplings/buy
...
data modify storage gm4_garden_variety:debug/arborist trades.level_1.sell_saplings append from storage gm4_garden_variety:data/arborist/next_trade Recipes.sell.id

# loop
scoreboard players remove trade_amount gm4_gv_trades 1
execute if score trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:arborist/trading/trades/level_1/sell_saplings