...
# select random trade
data modify storage gm4_garden_variety:data/arborist/random_trade_data armor_stand_data set from entity @e[type=armor_stand,tag=gm4_gv_decorative_trade_option,limit=1,sort=random] {}
...
# modify lore
data modify storage gm4_garden_variety:data/arborist/next_trade Recipes.sell.tag.display.Lore[0] set value '{"italic":true,"color":"gray","text":"An elegant sapling bought from the arborist"}'
...
data modify storage gm4_garden_variety:debug/arborist trades.sell_decorative_saplings append from storage gm4_garden_variety:data/arborist/next_trade Recipes.sell.id

# loop
scoreboard players remove trade_amount gm4_gv_trades 1
execute if score trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:arborist/trading/trades/sell_decorative_saplings