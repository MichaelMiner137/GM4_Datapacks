...
execute if entity @s[tag=!gm4_gv_can_restock,tag=gm4_gv_has_job_site] if score @s gm4_gv_trades matches 1.. store result score xp_value gm4_gv_arborist run data get storage gm4_garden_variety:temp/villager NBT.Xp
