...
execute if data storage gm4_garden_variety:data/analyzer Items[{Slot:1b}].tag.gm4_garden_variety.traits{enabled:0b} run function gm4_garden_variety:analyzer/recipes/invalid_item/check
execute if data storage gm4_garden_variety:data/analyzer Items[{Slot:0b,id:"minecraft:paper"}] run function gm4_garden_variety:analyzer/recipes/paper_report/check
execute if data storage gm4_garden_variety:data/analyzer Items[{Slot:0b,id:"minecraft:book",Count:1b}] run function gm4_garden_variety:analyzer/recipes/book_report/check
execute if data storage gm4_garden_variety:data/analyzer Items[{Slot:0b,id:"minecraft:name_tag"}] run function gm4_garden_variety:analyzer/recipes/tagged_sapling/check
execute if data storage gm4_garden_variety:data/analyzer Items[{Slot:0b,id:"minecraft:shears"}] run function gm4_garden_variety:analyzer/recipes/remove_tag/check
execute if data storage gm4_garden_variety:data/analyzer Items[{Slot:0b,id:"minecraft:bone_meal"}] run function gm4_garden_variety:analyzer/recipes/convert_sapling/check
