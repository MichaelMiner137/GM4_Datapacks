...
# set requirements
scoreboard players set analyzing_speed gm4_gv_analyze 3
...
execute if score analyzing_speed gm4_gv_analyze matches 61.. run scoreboard players set analyzing_speed gm4_gv_analyze 60

# analyze
function gm4_garden_variety:analyzer/recipes/analyzing

# particle
particle item oak_sapling ~ ~1.2 ~ 0 0 0 .1 3

# complete
execute if score @s gm4_gv_analyze >= analyzing_speed gm4_gv_analyze run function gm4_garden_variety:analyzer/recipes/convert_sapling/complete
