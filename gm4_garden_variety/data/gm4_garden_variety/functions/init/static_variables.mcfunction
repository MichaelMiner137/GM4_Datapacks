...
scoreboard players set #-90 gm4_math_num -90
scoreboard players set #-85 gm4_math_num -85
scoreboard players set #-80 gm4_math_num -80
scoreboard players set #-75 gm4_math_num -75
scoreboard players set #-70 gm4_math_num -70
scoreboard players set #-75 gm4_math_num -75
scoreboard players set #-60 gm4_math_num -60
scoreboard players set #-55 gm4_math_num -55
scoreboard players set #-50 gm4_math_num -50
scoreboard players set #-45 gm4_math_num -45
scoreboard players set #-40 gm4_math_num -40
scoreboard players set #-30 gm4_math_num -30
...
scoreboard players set #97 gm4_math_num 97
scoreboard players set #99 gm4_math_num 99
