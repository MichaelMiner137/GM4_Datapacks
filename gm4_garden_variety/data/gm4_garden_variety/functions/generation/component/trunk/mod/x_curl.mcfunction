...
execute if score $x.curl.start gm4_gv_component matches 1.. if score #builder.current_length gm4_gv_component < $x.curl.start gm4_gv_component run scoreboard players set #builder.y_curl_ac gm4_gv_component -1
execute if score $x.curl.stop gm4_gv_component matches 1.. if score #builder.current_length gm4_gv_component > $x.curl.stop gm4_gv_component run scoreboard players set #builder.y_curl_ac gm4_gv_component -1
execute if score #builder.y_curl_ac gm4_gv_component matches 0 unless score $x.curl.static gm4_gv_component matches 1 run function gm4_garden_variety:generation/component/trunk/calc/x_curl
