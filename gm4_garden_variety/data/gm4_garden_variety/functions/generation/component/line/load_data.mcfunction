...
execute store result score #active_pointer.x.bend.direction gm4_gv_component run data get storage gm4_garden_variety:reference pointer.x.bend.direction
execute store result score #active_pointer.y.bend.direction gm4_gv_component run data get storage gm4_garden_variety:reference pointer.y.bend.direction
...
execute store result score $x.bend.force_direction gm4_gv_component run data get storage gm4_garden_variety:reference component.x.bend.force_direction
...
execute store result score $y.bend.random_direction gm4_gv_component run data get storage gm4_garden_variety:reference component.y.bend.random_direction
...
execute if score $x.bend.force_direction gm4_gv_component matches -1 run function gm4_garden_variety:generation/component/line/correction/x-bend-random_direction
execute if score $y.bend.random_direction gm4_gv_component matches -1 run function gm4_garden_variety:generation/component/line/correction/y-bend-force_direction
execute if score $x.bend.force_direction gm4_gv_component matches 0 if score #active_pointer.x.bend.direction gm4_gv_component matches 0 run function gm4_garden_variety:generation/component/line/correction/x-bend-random_direction
execute if score $y.bend.random_direction gm4_gv_component matches 0 if score #active_pointer.y.bend.direction gm4_gv_component matches 0 run function gm4_garden_variety:generation/component/line/correction/y-bend-force_direction
execute if score $x.bend.force_direction gm4_gv_component matches 0 unless score #active_pointer.x.bend.direction gm4_gv_component matches 0 run function gm4_garden_variety:generation/component/line/correction/x-bend-inherit_direction
execute if score $y.bend.random_direction gm4_gv_component matches 0 unless score #active_pointer.y.bend.direction gm4_gv_component matches 0 run function gm4_garden_variety:generation/component/line/correction/y-bend-inherit_direction
