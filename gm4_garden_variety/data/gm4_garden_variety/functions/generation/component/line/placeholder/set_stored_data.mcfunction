...
execute store result storage gm4_garden_variety:new placeholder.length_current int 1 run scoreboard players get #line_marker.length_current gm4_gv_component
...
# waterlogged: gm4_garden_variety:generation/placeholder/place
