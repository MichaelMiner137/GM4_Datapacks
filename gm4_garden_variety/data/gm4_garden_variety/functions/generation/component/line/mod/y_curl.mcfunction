...
scoreboard players operation #builder.y_curl_ac gm4_gv_component %= $y.curl.frequency gm4_gv_component
execute if score $y.curl.start gm4_gv_component matches 1.. if score #builder.length.current gm4_gv_component < $y.curl.start gm4_gv_component run scoreboard players set #builder.y_curl_ac gm4_gv_component -1
execute if score $y.curl.stop gm4_gv_component matches 1.. if score #builder.length.current gm4_gv_component > $y.curl.stop gm4_gv_component run scoreboard players set #builder.y_curl_ac gm4_gv_component -1
execute if score #builder.y_curl_ac gm4_gv_component matches 0 unless score $y.curl.static gm4_gv_component matches 1 run function gm4_garden_variety:generation/component/line/calc/y_curl
