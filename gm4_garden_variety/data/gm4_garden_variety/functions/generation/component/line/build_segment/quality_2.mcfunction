...
execute if score #line_generator.segments_left gm4_gv_component matches 1.. at @s run function gm4_garden_variety:generation/component/line/build_segment/quality_2
