...
execute if score #component_success gm4_garden_variety matches 1 if data storage gm4_garden_variety:reference component{type:"garden_variety:disc"} run function gm4_garden_variety:generation/component/disc/init_component
