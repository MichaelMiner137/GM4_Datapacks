...
execute if score debug_generation gm4_tree_data matches 1 run particle barrier ~ ~.5 ~-7
execute if score debug_generation gm4_tree_data matches 1 at @s align xyz positioned ~.5 ~.5 ~.5 run particle barrier ~7 ~ ~
