...
# run from #gm4_garden_variety:generation/palm_tree/initialize
...
execute at @s run function #gm4_garden_variety:generation/palm_tree/trunk_layer

# summon leaf marker and begin generation (generation)
...
execute if score leaf_start gm4_tree_data = current_trunk_layer gm4_tree_data at @s run execute as @e[type=area_effect_cloud,tag=gm4_tree_leaf,limit=1,sort=nearest] at @s run function gm4_garden_variety:generation/palm_tree/leaf

# generate trunk layer and move forward (generation)
scoreboard players set trunk_segment_loop gm4_tree_data 10
execute if score trunk_layer_loop gm4_tree_data matches 1.. at @s run function #gm4_garden_variety:generation/palm_tree/trunk_segment
...
execute if score trunk_layer_loop gm4_tree_data matches 0.. run function gm4_garden_variety:generation/palm_tree/trunk
