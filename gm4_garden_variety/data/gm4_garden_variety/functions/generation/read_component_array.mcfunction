...
# debug
#say -----
#tellraw @p [{"nbt":"component.type","storage":"gm4_garden_variety:reference"}]
#execute as @e[type=marker,tag=gm4_gv_generation_pointer] run tellraw @p [{"score":{"name":"@s","objective":"gm4_gv_pointer"}}," = ",{"score":{"name":"$target","objective":"gm4_gv_component"}}]
