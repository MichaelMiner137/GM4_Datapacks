...
# check blocks
execute unless block ~ ~ ~ #gm4_fruiting_trees:tree_part run scoreboard players set clearance_check gm4_gv_gen_data 0
...
execute if score clearance_check_segment_loop gm4_gv_gen_data matches 1.. run function gm4_garden_variety:generation/trees/palm_tree/clearance/segment
