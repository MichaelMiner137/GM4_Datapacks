...
data remove storage gm4_garden_variety:macro get_group_data
execute unless score $composite_group gm4_gv_placeholder matches 2..6 run data modify storage gm4_garden_variety:macro get_group_data.direction set value "up"
execute if score $composite_group gm4_gv_placeholder matches 2 run data modify storage gm4_garden_variety:macro get_group_data.direction set value "down"
execute if score $composite_group gm4_gv_placeholder matches 3 run data modify storage gm4_garden_variety:macro get_group_data.direction set value "north"
execute if score $composite_group gm4_gv_placeholder matches 4 run data modify storage gm4_garden_variety:macro get_group_data.direction set value "south"
execute if score $composite_group gm4_gv_placeholder matches 5 run data modify storage gm4_garden_variety:macro get_group_data.direction set value "east"
execute if score $composite_group gm4_gv_placeholder matches 6 run data modify storage gm4_garden_variety:macro get_group_data.direction set value "west"
