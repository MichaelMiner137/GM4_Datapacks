...
execute at @s run summon area_effect_cloud ~ ~ ~ {Tags:["gm4_gv_soil_converter"]}
execute at @s run tp @e[type=area_effect_cloud,tag=gm4_gv_soil_converter,limit=1,sort=nearest] ~ ~-0.5 ~
execute at @s run execute as @e[type=area_effect_cloud,tag=gm4_gv_soil_converter,limit=1,sort=nearest] at @s run function gm4_garden_variety:generation/soil_conversion/converter
