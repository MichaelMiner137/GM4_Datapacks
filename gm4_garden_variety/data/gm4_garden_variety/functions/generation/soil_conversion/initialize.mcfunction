...
execute at @s positioned ~ ~-.5 ~ run summon area_effect_cloud ~ ~ ~ {Tags:["gm4_gv_soil_converter_marker"]}
execute at @s run execute as @e[type=area_effect_cloud,tag=gm4_gv_soil_converter_marker,limit=1,sort=nearest] at @s run function gm4_garden_variety:generation/soil_conversion/converter
