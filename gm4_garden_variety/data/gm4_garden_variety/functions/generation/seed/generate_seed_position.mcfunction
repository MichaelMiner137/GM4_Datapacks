...
execute store result score #seed.1 gm4_gv_generation run data get storage gm4_garden_variety:reference sapling_marker.Pos[0]
scoreboard players operation #seed.1 gm4_gv_generation *= #1 gm4_garden_variety
execute store result score #seed.2 gm4_gv_generation run data get storage gm4_garden_variety:reference sapling_marker.Pos[1]
scoreboard players operation #seed.2 gm4_gv_generation *= #100 gm4_garden_variety
execute store result score #seed.3 gm4_gv_generation run data get storage gm4_garden_variety:reference sapling_marker.Pos[2]
