...
# spawn apple
execute if data entity @s[tag=gm4_ripe_red_berry_fruit] HandItems[0].id positioned ~0.5 ~1.5 ~0.5 run function gm4_garden_variety:generation/fruiting/leaves/red_berry/spawn_fruit
