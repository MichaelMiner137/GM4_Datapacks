...
# at @s align xyz
# run from gm4_garden_variety:fruiting/tree/validate_species

# determine available height
function gm4_garden_variety:generate/palm_tree/king_palm/fruiting/tree/layer/check_clear_space
