...
execute unless score $max_layer gm4_tree_layer >= #king_palm_max_height gm4_tree_limit positioned ~ ~1 ~ if predicate gm4_fruiting_trees:5x5_clear run function gm4_garden_variety:generate/palm_tree/king_palm/fruiting/tree/layer/check_clear_space
