...
# initialize
execute as @e[type=armor_stand,tag=gm4_fruiting_leaf_new,limit=1] at @s run function gm4_garden_variety:generate/palm_tree/king_palm/fruiting/leaf/fruit/initialize
