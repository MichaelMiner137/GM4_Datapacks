...
execute if score trunk_layer_eo2 gm4_tree_data matches 1 at @s run fill ~ ~ ~ ~ ~ ~ stripped_birch_wood replace #gm4_fruiting_trees:tree_part
...
scoreboard players remove trunk_segment_loop gm4_tree_data 1
execute if score trunk_segment_loop gm4_tree_data matches 1.. run function gm4_garden_variety:generate/palm_tree/king_palm/generation/trunk_segment
