...
# run from gm4_garden_variety:generate/palm_tree/king_palm/generation

# prepare settings
scoreboard players reset * gm4_tree_type
scoreboard players set king_palm gm4_tree_type 1 

# generate seed and tree variables
...
function gm4_garden_variety:generate/palm_tree/king_palm/generation/variables/per_tree

# align and begin generation
execute as @s align xyz positioned ~.5 ~ ~.5 run tp @s ~ ~ ~
execute as @s at @s run function #gm4_garden_variety:generation/palm_tree/generate