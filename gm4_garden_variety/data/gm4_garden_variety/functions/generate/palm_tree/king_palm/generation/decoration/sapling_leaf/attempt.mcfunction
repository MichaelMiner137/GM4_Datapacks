...
execute if score sapling_leaf_success gm4_tree_data matches 1..2 at @s align xyz positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #minecraft:leaves run function gm4_garden_variety:generate/palm_tree/king_palm/generation/decoration/sapling_leaf/place
