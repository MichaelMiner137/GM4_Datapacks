...
########## FLEXIBILITY ##########
# stiff (1)
execute if score flexibility gm4_gv_nbt_data matches 1 run scoreboard players set trunk_arc gm4_tree_data 0
...
# sturdy (2)
execute if score flexibility gm4_gv_nbt_data matches 2 if score trunk_arc gm4_tree_data matches 1.. run scoreboard players remove trunk_arc gm4_tree_data 1
# flexible (4)
execute if score flexibility gm4_gv_nbt_data matches 4 run scoreboard players add trunk_arc gm4_tree_data 1
...
# flexible (5)
execute if score flexibility gm4_gv_nbt_data matches 5 run scoreboard players add trunk_arc gm4_tree_data 2
execute if score flexibility gm4_gv_nbt_data matches 5 run scoreboard players add trunk_arc_addition_rate gm4_tree_data 2
execute if score flexibility gm4_gv_nbt_data matches 5 run scoreboard players add trunk_arc_addition_amount gm4_tree_data 1
...
execute if score foliage gm4_gv_nbt_data matches 4 run scoreboard players add leaf_layer_start_minimum gm4_tree_data 1
# tallest (5)
...
execute if score foliage gm4_gv_nbt_data matches 5 run scoreboard players add leaf_layer_start_minimum gm4_tree_data 2
