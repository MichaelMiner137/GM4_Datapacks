...
execute if block ~ ~-1 ~ minecraft:sand positioned ~ ~2 ~ if predicate gm4_fruiting_trees:3x3_clear positioned ~ ~-2 ~ run function gm4_natural_trees:generate/palm_tree/king_palm/orbis/chunk/spawn_tree
