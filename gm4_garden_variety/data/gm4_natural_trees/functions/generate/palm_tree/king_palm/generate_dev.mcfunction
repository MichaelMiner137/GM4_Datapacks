...
# set variables
scoreboard players set height gm4_gv_nbt_data 3
scoreboard players set flexibility gm4_gv_nbt_data 3
scoreboard players set foliage gm4_gv_nbt_data 5
scoreboard players set fertility gm4_gv_nbt_data 3
