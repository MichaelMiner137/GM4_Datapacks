...
execute as @e[type=minecraft:area_effect_cloud,tag=gm4_king_palm_tree_new,limit=1] at @s align xyz run function gm4_natural_trees:generate/king_palm/orbis/chunk/generate_seed
