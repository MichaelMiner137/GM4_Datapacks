...
kill @s[type=!player]
execute align xyz positioned ~.5 ~ ~.5 run summon area_effect_cloud ~ ~ ~ {Tags:["gm4_tree_trunk_marker"]}
execute as @e[type=area_effect_cloud,tag=gm4_tree_trunk_marker,limit=1,sort=nearest] at @s run function gm4_natural_trees:generate/king_palm/generation/initialize
