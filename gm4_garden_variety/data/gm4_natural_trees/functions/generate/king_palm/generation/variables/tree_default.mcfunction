...
scoreboard players set trunk_segments gm4_tree_data 10
...
scoreboard players set leaf_layer_start_side gm4_tree_data 1

# amount of segments in a leaf layer for the tree (2)
scoreboard players set leaf_segments gm4_tree_data 2
...
scoreboard players set palm_segments gm4_tree_data 10
...
scoreboard players set fruit_leaves_start_height gm4_tree_data 1
