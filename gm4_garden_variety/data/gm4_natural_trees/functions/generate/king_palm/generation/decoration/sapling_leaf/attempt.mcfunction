...
execute if score sapling_leaf_success gm4_tree_data matches 0 at @s align xyz positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #minecraft:leaves[persistent=false] run function gm4_natural_trees:generate/king_palm/generation/decoration/sapling_leaf/place
