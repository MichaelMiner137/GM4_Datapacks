...
execute if score sapling_leaf_success gm4_gv_gen_data matches 0 at @s if block ~ ~ ~ #minecraft:leaves[persistent=false] run function gm4_natural_trees:generate/king_palm/generation/leaves/sapling/place
